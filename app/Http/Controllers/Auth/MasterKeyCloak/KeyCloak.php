...
//namespace MasterKeyCloak;
namespace App\Http\Controllers\Auth\MasterKeyCloak;
class KeyCloak {
	public $grant;
     ...
     * @param $username
     * @param $password
     * @return bool {Boolean} TRUE for success or FALSE for failure TRUE for success or FALSE for failure
     */
     ...
     * @param null $session_host
     * @return bool|null {Boolean} TRUE for success or FALSE for failure TRUE for success or FALSE for failure
     */
	public function grant_from_code ($code, $redirect_uri = '', $session_host = NULL) {
	    //dd([$code,$redirect_uri,$session_host,$this->client_id]);
		$params = array(
     ...
     * @param bool $remote
     * @return bool {boolean} FALSE if the token is invalid, or TRUE if token is valid. FALSE if the token is invalid, or TRUE if token is valid.
     */
