              ...
              <div id="login-form-body" class="img-responsive">
                  <form id="loginForm" action="{{'login'}}" method="POST" class="login">
                      ...
                      <div class="form-group">
                          <input name="username" type="text" class="form-control input_user" value="" id="tendangnhap" placeholder="Tên đăng nhập" >
                      </div>
                      <div class="form-group">
                          <input name="password" type="password" class="form-control input_pass" value="" placeholder="Mật khẩu" id="matkhau">
                      </div>
                      <div class="form-group">
