...
@section('main')
    <div class="container-fuild">
        <div class="row">
            ...
            <form action="{{route('luu_xu_ly_van_ban_donvi')}}" id="xulyvanban" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                    ...
                    <div style="display: flex;">
                        ...
                        <div style="display: flex;justify-content: flex-end;flex: 1;">
                            <a href="{{ route('chitiet_vanban_donvi', [$vanbanden->id, 'tab' => 2]) }}" class="btn btnLuanChuyen" style="margin-right: 15px;"><i class="fa fa-envelope-open" style="color: #26a9e0"></i> Trao đổi văn bản</a>
