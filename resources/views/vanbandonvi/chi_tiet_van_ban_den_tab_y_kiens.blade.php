            ...
            @if($ykiens)
                ...
                <tr>
                    ...
                    <td style="text-align: center; width: 60px;">
                        @if ($ykien->created_by != session('user')['id'])
                            <a href="javascript:;" class="btn-reply" creator={{ $ykien->created_by }}><i class="fa fa-reply" title="Trả lời"></i></a>
                        @endif
                    </td>
                </tr>
                @endforeach
...
<div id="ModalFormYKien" class="modal fade 1" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('trinh_lanh_dao.save_ykien_donvi') }}" method="POST" enctype="multipart/form-data">
...
<script>
    ...
    $('.btn-reply').click(function () {
        let creatorId = $(this).attr('creator');
