    ...
    <div class="row">
        <div class="row">
            ...
            <div class="col-md-3 text-right" style="margin-top: 15px">
                <a class="btn btn-primary" style="margin-bottom: 15px;" href="{{ route('nhap_vanban_banhanh_donvi') }}"><i class="fa fa-pencil-square-o"></i> Nhập văn bản ban hành</a>
            </div>
        </div>
        ...
        <div class="col-md-12" style="display: flex;justify-content: space-between;padding: 0;margin-bottom: 18px;">
            <ul class="nav nav-pills">
                <li class="bg_luanchuyen {{ (!$type || $type == 'nhanvanban')? 'active' : '' }}">
                    <a href="{{ route('danhsach_vanban_banhanh_donvi', ['type' => 'nhanvanban']) }}">VB Ban hành đã nhận</a>
                </li>
                <li class="bg_luanchuyen {{ $type == 'guivanban'? 'active' : '' }}">
                    <a href="{{ route('danhsach_vanban_banhanh_donvi', ['type' => 'guivanban']) }}">VB ban hành đã gửi</a>
                </li>
            </ul>
            <div>
        ...
        <div class="container-search hidden">
            <div class="row">
                <div class="col-md-12">
                    <form class="form-filter" method="GET" action="{{ route('danhsach_vanban_banhanh_donvi') }}">
