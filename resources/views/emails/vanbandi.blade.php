<div>
    ...
    <table border="1" width="100%" style="border-collapse:collapse">
        ...
        <tr>
            ...
            <td>&nbsp;{{$data['kyhieu']}}</td>
            <td width="124">Ngày ban hành</td>
            <td width="195">&nbsp;{{$data['ngaydi']}}</td>
        </tr>
        <tr>
    ...
    @php
        ...
        foreach($files as $key => $file) {
            if (isset($data['isvanbandonvi']) && $data['isvanbandonvi']) {
                ...
                echo sprintf('<div><a href="%s" target="_blank" title="%s">%s</a></div>', route('dowload.file', [$file, 'vanban_donvi_id' => $data['id'],'numberFile' => $key]), $file, $file);
            }
        }
    @endphp
</div>