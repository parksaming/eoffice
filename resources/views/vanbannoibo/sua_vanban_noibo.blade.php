...
<div class="container-fuild pdt20">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="title-text">Sửa văn bản nội bộ</h4>
        </div>
        <div class="col-sm-12">
            <form id="FormEditVBDen" class="form-input" action="{{ url('vanbannoibo/luu-sua') }}" method="POST" enctype="multipart/form-data">
                <div class="form-row">
