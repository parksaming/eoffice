...
@section('main')
    <div class="container-fuild">
        <div class="row">
            <div class="col-sm-12">
                <h4 class="title-text">Chuyển xử lý văn bản nội bộ</h4>
            </div>
            <form action="{{ url('vanbannoibo/luu-chuyen-xu-ly') }}" id="xulyvanban" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                    ...
                    <div style="display: flex;">
                        ...
                        <div style="display: flex;justify-content: flex-end;flex: 1;">
                            <a href="{{ url('vanbannoibo/chi-tiet', [$vanbanden->id]).'?tab=2' }}" class="btn btnLuanChuyen" style="margin-right: 15px;"><i class="fa fa-envelope-open" style="color: #26a9e0"></i> Trao đổi văn bản</a>
