...
<div class="container-fuild pdt20">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="title-text">Ban hành văn bản nội bộ</h4>
        </div>
        <div class="col-sm-12">
            <form id="FormNhapVBDen" class="form-input" action="{{ url('vanbannoibo/luu-nhap') }}" method="POST" enctype="multipart/form-data">
                <div class="form-row">
...
<script>
    ...
    $('select[name="donvi_id"]').change(function () {
        ...
        loadUserDonViNoiBoCheckBox([donviId], '#UserChutriContainer', {checkbox_name: 'user_chutri_ids[]'});
    });
    ...
    $('select[name="donvi_phoihop_ids[]"]').change(function () {
        ...
        loadUserDonViNoiBoCheckBox(donviIds, '#UserPhoihopContainer', {checkbox_name: 'user_phoihop_ids[]', selected_values:selectedValues});
    });
