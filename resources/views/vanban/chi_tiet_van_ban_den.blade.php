        ...
        <div id="exTab1">
            ...
            <div class="tab-content clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="pull-right btn-custom" style="display: flex">
                            ...
                            @if ($vanbanden->user_id == session('user')['id'])
                                <a class="color-w btn btn-primary mg-l10" href="{{route('edit_vanban', $vanbanden->id)}}" title="Sửa văn bản"> Sửa văn bản</a>
                                <a class="color-w btn btn-primary mg-l10" href="javascript:;" onclick="showModalGuiLaiMail()" title="Gửi lại mail"> Gửi lại mail</a>
                            @endif
                            <a class="color-w btn btn-primary mg-l10" href="{{route('chuyen_xu_ly_van_ban', $vanbanden->id)}}" title="Chuyển xử lý văn bản"> Chuyển xử lý văn bản</a>
                ...
                <div class="tab-pane {{ $tab == 3? 'active' : '' }}" id="4a">
                    ...
                    @include('congviecs._danh_sach_cong_viec', ['vanbanxuly' => $vanBanXuLy])
                </div>
            </div>
        </div>
    </div>
