...
@section('main')
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12">
                <form action="{{route('edit_vanban_luu')}}" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <div class="col-md-12 vanban">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="file" class="btn btn-success"  accept=".jpg,.png,.gif,.pdf" style="width: 100%" id="upload_file">
                                        </div>
                                        <div class="col-md-6">
                                            <div id="upload_status_file">
                                                <p style="padding-top:7px;color: red"><i>Chỉ cho upload định dạng file: jpg, png, gif, pdf với dung lượng < 20M</i></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 vanban">
                            <div class="row" style="display: flex">
                                ...
                                <div class="col-md-10" style="display: flex">
                                    <textarea  class="form-control" name="title" id="name"  rows="5" >{{$vanbans->title}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 vanban">
                                    ...
                                    <div class="row">
                                            ...
                                            <select class="form-control" name="loaivanban_id" id="loaivanban">
                                                ...
                                                @foreach ($loaivanbans as $loaivanban)
                                                    @if ($loaivanban->id == $vanbans->loaivanban_id)
                                                        <option value="{{$loaivanban->id}}" selected>{{$loaivanban->name}}</option>
                                                    @else
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="ngayden" id="startngayden" value="{{$vanbans->ngayden}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 vanban">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="soden" id="soden" value="{{$vanbans->soden}}">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="kyhieu" id="kyhieu" value="{{$vanbans->kyhieu}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <select class="form-control" name="cq_banhanh" id="cqbanhanh" >
                                                @foreach($donvis as $donvi)
                                                    @if ($donvi->id == $vanbans->cq_banhanh)
                                                        <option value="{{$donvi->id}}" selected>{{$donvi->name}}</option>
                                                    @else
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="ngayky" id="ngayky" value="{{$vanbans->ngayky}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <select class="form-control" id="" name="linhvuc_id">
                                                ...
                                                @foreach ($linhvucs as $linhvuc)
                                                    @if ($linhvuc->id == $vanbans->linhvuc_id)
                                                        <option value="{{$linhvuc->id}}" selected>{{$linhvuc->name}}</option>
                                                    @else
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="nguoiky" value="{{$vanbans->nguoiky}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 vanban">
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="hanxuly" id="hanxuly" value="{{$vanbans->hanxuly}}">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="publish">
                                                        ...
                                                        @foreach ($publishs as $publish)
                                                            @if ($publish->id == $vanbans->publish_id)
                                                                <option value="{{$publish->id}}" selected>{{$stt++ . '.'.$publish->name}}</option>
                                                                @else
                        ...
                        <div class="col-md-12 vanban">
                            <div class="row" style="display: flex">
                                ...
                                <div class="col-md-10" style="display: flex">
                                    <textarea  class="form-control" name="note" id="note"  rows="5">{{$vanbans->note}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12 vanban">
                            ...
                            <p><i>Chỉ cho upload định dạng file: <span style="color: green;">doc, docx, xls, xlsx, ppt, pptx, pdf</span> với dung lượng < 20M</i></p>
                            <div id="file_list">
                                <?php
                                ...
                                <div class="item" id="row{{$row}}">
                                    ...
                                    <div style="float:right">
                                        <a href="javascript:void(0)" id="{{$file[$i]}}" onClick="remove_file(this)" rel="{{$row}}">
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach ($book_detail as $book)
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $donvi = App\Donvi::where('id',$book->donvi_id)->first();
                                            ?>
                                            <strong>{{$donvi->name}}</strong>
                                        </td>
                                        <td>
                                            <input type="checkbox" name="noinhan[]" value="{{$donvi->id}}">
                                        </td>
                                        <td>{{$book->donvi_email}}</td>
                                    </tr>
                                    @if ($book->user_id)
                                        <?php
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>&nbsp;&nbsp;{{$user->fullname}}</td>
                                                <td>
                                                    <input type="checkbox" name="usernhan[]" value="{{$user->id}}">
                                                </td>
                                                <td>{{$user->email}}</td>
                                                @endforeach
                                            </tr>
