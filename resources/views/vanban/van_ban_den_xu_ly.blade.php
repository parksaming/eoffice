                ...
                @foreach ($vanbanxulys as $vanbanxuly)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span style="padding:5px 10px"><a href="{{route('chuyen_xu_ly_van_ban',$vanbanxuly->vanbanUser_id)}}" title="Chuyển xử lý văn bản"><i class="fa fa-share" aria-hidden="true"></i></a></span>
{{--                            <span style="padding:5px 10px"><a href="{{route('gui_but_phe_van_ban_den',$vanbanxuly->id)}}" title="Gửi bút phê"><i class="fa fa-paper-plane" aria-hidden="true"> </i></a></span>--}}
                            <span style="padding:5px 10px"><a href="{{route('chitiet_vanban',$vanbanxuly->vanbanUser_id)}}" title="Xem chi tiết"><i class="fa fa-eye"> </i></a></span>
