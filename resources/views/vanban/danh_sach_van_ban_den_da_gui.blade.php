                ...
                @foreach ($ds_vanbans as $ds)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <span style="padding:5px 10px"><a href ="{{route('edit_van_ban_da_gui',$ds->id)}}"><i class="fa fa-pencil"> </i></a></span>
{{--                            <span style="padding:5px 10px"><a href="{{route('chitiet_vanban',$ds->id)}}"><i class="fa fa-eye"> </i></a></span>--}}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
