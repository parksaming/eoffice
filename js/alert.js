        ...
        _show: function(title, msg, value, type, callback) {
            ...
            $("BODY").append(
              '<div id="popup_container"><div class="divPopup_wrapper">' +
                '<div class="barpopup"><div class="titlepopup" id="popup_title"></div><div title="Close" class="close" style="float: right;" id="popup_close">×</div></div>' +
            ...
            switch( type ) {
                ...
                break;
                case 'confirm':
                    $("#popup_message").after('<div id="popup_panel_two"><a class="ok btn btn-success" id="popup_ok">' + $.alerts.okButton + '</a> <a class="cancel btn btn-danger" id="popup_cancel">' +  $.alerts.cancelButton + '</a></div>');
                    $("#popup_ok").click( function() {
                        $.alerts._hide();
