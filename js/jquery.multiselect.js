...
(function($){
    ...
    MultiSelect.prototype = {
            ...
            if( instance.options.search ) {
                ...
                search.on('keyup', function(){
                    ...
                    $(this).data('searchTimeout', setTimeout(function(){
                        ...
                        instance._updateSelectAllTextAfterSearch();
                        
                        
                        // USER CALLBACK
                        if( typeof instance.options.searchOptions.afterSearch == 'function' ) {
                            instance.options.searchOptions.afterSearch( instance.element );
                        }
        ...
        // update the un/select all texts based on selected options and visibility after search
        _updateSelectAllTextAfterSearch: function( visibleOnly ){
